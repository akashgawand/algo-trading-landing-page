    ...
    <section className="relative w-full min-h-screen overflow-hidden bg-[#020617] pb-20 pt-32 font-sans text-white antialiased md:pb-32 md:pt-40">
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 text-center md:px-6">
        ...
        >
          ...
          {/* <div className="absolute right-[-20%] top-[30%] w-[400px] h-[400px] opacity-30">
            <div
              className="w-full h-full rounded-full"
              style={{
                background:
          ...
          <h1 className="mx-auto mb-6 max-w-4xl font-sans text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-gray-400 md:text-6xl lg:text-7xl">
          ...
          {/* <Image 
            ...
            height={300} 
            priority
            className="absolute top-0 left-1/2 -translate-x-1/2 -z-50 w-full min-w-[700px] object-contain pointer-events-none opacity-10 " 
          /> */}
