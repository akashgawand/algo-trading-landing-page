    ...
    `,
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-12 gap-5 auto-rows-min">
                    ...
                    <div className="col-span-3 row-span-2 bg-white/[0.03] rounded-3xl p-5 border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05),0_20px_40px_rgba(0,0,0,0.4)] relative overflow-hidden group transition-all duration-500 hover:bg-white/[0.06]">
                    ...
                    <div className="col-span-3 bg-white/[0.03] rounded-3xl p-5 border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05),0_20px_40px_rgba(0,0,0,0.4)] relative group transition-all duration-500 hover:bg-white/[0.06]">
                    ...
                    <div className="col-span-3 bg-white/[0.03] rounded-3xl p-5 border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05),0_20px_40px_rgba(0,0,0,0.4)] group transition-all duration-500 hover:bg-white/[0.06]">
                    ...
                    <div className="col-span-3 row-span-2 bg-white/[0.03] rounded-3xl overflow-hidden border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05),0_20px_40px_rgba(0,0,0,0.4)] relative group transition-all duration-500 hover:bg-white/[0.06]">
                        <div className="p-5">
                    ...
                    <div className="col-span-4 row-span-2 bg-white/[0.04] rounded-3xl p-6 border border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.1),0_30px_60px_rgba(0,0,0,0.5)] relative group transition-all duration-500 hover:bg-white/[0.08]">
                    ...
                    {/* Service Rating */}
                    <div className="col-span-2 bg-white/[0.03] rounded-3xl p-4 border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05)] transition-all duration-500 hover:bg-white/[0.06]">
                    ...
                    <div className="col-span-3 bg-white/[0.03] rounded-3xl p-5 border border-white/10 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05)] group transition-all duration-500 hover:bg-white/[0.06]">
                        <div className="flex gap-1 mb-3">
                            {[...Array(5)].map((_, i) => (
                                <Star key={i} className="w-3 h-3 fill-emerald-400 text-emerald-400" />
                            ))}
                    ...
                    {/* Your Feedback */}
                    <div className="col-span-3 bg-white/[0.04] rounded-[2rem] p-5 border border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.05),0_20px_40px_rgba(0,0,0,0.4)] relative group transition-all duration-500 hover:bg-white/[0.08]">
