...
bg-gradient-to-t from-[#0a0613] via-[#0a0613]/60 to-transparent" />
            ...
            <div className="container relative z-10 mx-auto max-w-7xl px-4 py-24 md:px-6 lg:py-32">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-20">
                        ...
                        <motion.div {...fadeIn} transition={{ delay: 0.1 }} className="relative group">
                            ...
                            <div className="space-y-8 text-slate-400 leading-relaxed text-lg">
                                ...
                                <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/[0.05]  overflow-hidden group-hover:border-blue-500/20 transition-all duration-500">
                        ...
                        <motion.div {...fadeIn} transition={{ delay: 0.2 }} className="relative">
                            ...
                            <div className="relative bg-[#0a0a16]/80 border border-white/[0.05] rounded-[2.5rem] p-10 overflow-hidden shadow-2xl">
                                <div className="flex justify-between items-start mb-10">
                                    <div className="space-y-2">
                                        ...
                                        <h4 className="text-2xl font-bold text-white">System Reliability</h4>
                                    </div>
                                    <BarChart3 className="w-8 h-8 text-blue-500/50" />
                                </div>
                                <p className="text-slate-400 mb-10 leading-relaxed text-base italic border-l-2 border-white/5 pl-6">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <a href="https://gemalgo.trade" target="_blank" rel="noopener noreferrer" className="group/btn relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-bold text-sm transition-all hover:bg-blue-50 hover:scale-[1.02] active:scale-95">
                                        Performance Reports
                                        <ArrowRight className="w-4 h-4 transition-transform group-hover/btn:translate-x-1" />
                                    </a>
                                    <a href="https://gemalgo.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-bold text-sm hover:bg-white/10 transition-all">
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        <motion.div 
                            ...
                            className="bg-[#0f111a]/50 border border-white/[0.05] rounded-[3rem] p-10 sticky top-24  shadow-[0_0_50px_rgba(0,0,0,0.3)]"
                        >
                ...
                <div className="mt-40 pt-20 border-t border-white/5">
                    <motion.div {...fadeIn} className="max-w-5xl mx-auto">
                        ...
                        <div className="mt-20 pt-10 border-t border-white/5 flex flex-wrap justify-center gap-x-8 gap-y-3">
